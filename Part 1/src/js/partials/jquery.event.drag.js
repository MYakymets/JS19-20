...
$.fn.drag = function( str, arg, opts ){
	...
	// return fn ? this.bind( type, opts, fn ) : this.trigger( type );   //del
...
drag = $special.drag = {
	...
	hijack: function( event, type, dd, x, elem ){
		...
		// event.originalEvent = null;   // can`t understand why
	...
	properties: function( event, dd, ia ){
		...
		obj.deltaX = winEvent.pageX - dd.pageX;
		obj.deltaY = winEvent.pageY - dd.pageY;
	...
	textselect: function( bool ){
		// $( document )[ bool ? "unbind" : "bind" ]("selectstart", drag.dontstart )     // del
