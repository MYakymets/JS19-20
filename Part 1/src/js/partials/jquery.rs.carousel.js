    ...
    $.widget('rs.carousel', {
        ...
        _addNextPrevActions: function () {
            ...
            elems.prevAction = opts.insertPrevAction.apply(this.element[0])
                // .bind('click' + eventNamespace, function (e) {   // del
        ...
        _addPagination: function () {
            ...
            pagination
                .append(links.join(''))
                // .delegate('a', 'click' + this.eventNamespace, function (e) {   // del
                .on('click' + this.eventNamespace, 'a', function (e) {
                    e.preventDefault();
        ...
        _slide: function (e, silent) {
            ...
            if (this.options.translate3d) {
                ...
                this.elements.runner
                    // .unbind(transitionEndEvent.join(' '))    // del
                    .off(transitionEndEvent.join(' '))
