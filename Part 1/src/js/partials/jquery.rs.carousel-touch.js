...
(function ($) {
    ...
    $.widget('rs.draggable3d', {
        ...
        _bindDragEvents: function () {
            ...
            this.element
                // .unbind(eventNamespace)   // del
                .off(eventNamespace)
                // .bind('dragstart' + eventNamespace, {   // del
                .on('dragstart' + eventNamespace, {
                    axis: this.options.axis
                }, function (e) {
                    self._start(e);
                })
                // .bind('drag' + eventNamespace, function (e) {   // del
                .on('drag' + eventNamespace, function (e) {
                    self._drag(e);
                })
                // .bind('dragend' + eventNamespace, function (e) {
                .on('dragend' + eventNamespace, function (e) {  // del
                    self._end(e);
                });
